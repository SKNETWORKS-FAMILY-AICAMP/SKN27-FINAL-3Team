...
urlpatterns = [
    ...
    path("cases/", views.cases_collection, name="canonical-cases"),
    path("cases/<str:case_id>/workspace/", views.case_workspace, name="canonical-case-workspace"),
    path("cases/<str:case_id>/facts/confirm/", views.case_fact_confirmation, name="canonical-case-fact-confirmation"),
    path("cases/<str:case_id>/analysis/jobs/", views.case_analysis_jobs, name="canonical-case-analysis-jobs"),
