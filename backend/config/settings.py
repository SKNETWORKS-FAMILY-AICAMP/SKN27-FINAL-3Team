...
LEGAL_RAG_SEED_EMBEDDING_PROVIDER = os.environ.get("LEGAL_RAG_SEED_EMBEDDING_PROVIDER", "")
LEGAL_RAG_SEED_EMBEDDING_MODEL = os.environ.get("LEGAL_RAG_SEED_EMBEDDING_MODEL", "")
LEGAL_RAG_SEED_EMBEDDING_DIMENSIONS = os.environ.get("LEGAL_RAG_SEED_EMBEDDING_DIMENSIONS", "")
