...
OPERATIONAL_HEALTH_INTERVAL_SECONDS = _positive_int_env(
    "OPERATIONAL_HEALTH_INTERVAL_SECONDS",
    60,
)
OPERATIONAL_HEALTH_WINDOW_MINUTES = _positive_int_env(
    "OPERATIONAL_HEALTH_WINDOW_MINUTES",
    15,
)
OPERATIONAL_QUEUE_AGE_WARN_SECONDS = _positive_int_env(
    "OPERATIONAL_QUEUE_AGE_WARN_SECONDS",
    300,
)
OPERATIONAL_LEASE_STALE_SECONDS = _positive_int_env(
    "OPERATIONAL_LEASE_STALE_SECONDS",
    300,
)
OPERATIONAL_LEGAL_RUN_SUMMARY_PATH = os.environ.get(
    "OPERATIONAL_LEGAL_RUN_SUMMARY_PATH",
    "",
)
OPERATIONAL_LEGAL_MAX_AGE_HOURS = _positive_int_env(
    "OPERATIONAL_LEGAL_MAX_AGE_HOURS",
    168,
)
OPERATIONAL_LEGAL_REQUIRED_SOURCES = [
    source_id.strip()
    for source_id in os.environ.get(
        "OPERATIONAL_LEGAL_REQUIRED_SOURCES",
        "",
    ).split(",")
    if source_id.strip()
...
RAG_EMBEDDING_PROVIDER = os.environ.get("RAG_EMBEDDING_PROVIDER", "openai")
RAG_EMBEDDING_MODEL = os.environ.get("RAG_EMBEDDING_MODEL", "text-embedding-3-large")
...
LEGAL_RAG_QUERY_EMBEDDING_DIMENSIONS = os.environ.get(
...
LEGAL_RAG_SEED_EMBEDDING_PROVIDER = os.environ.get(
    "LEGAL_RAG_SEED_EMBEDDING_PROVIDER",
    RAG_EMBEDDING_PROVIDER,
)
LEGAL_RAG_SEED_EMBEDDING_MODEL = os.environ.get(
    "LEGAL_RAG_SEED_EMBEDDING_MODEL",
    RAG_EMBEDDING_MODEL,
)
LEGAL_RAG_SEED_EMBEDDING_DIMENSIONS = os.environ.get(
