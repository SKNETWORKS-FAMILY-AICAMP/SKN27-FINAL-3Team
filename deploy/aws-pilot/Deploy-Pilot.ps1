...
try {
    ...
    elseif ($StageForReleaseUpdate) {
        ...
        $commands += @(
            ...
            "$productionComposeCommand up -d --wait --wait-timeout 600 --remove-orphans `$OPERATIONAL_SERVICES",
