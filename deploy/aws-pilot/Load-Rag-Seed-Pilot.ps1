...
$runnerCommands = @(
    ...
    "$stageComposeCommand --profile seed run --rm --no-deps rag-loader python backend/manage.py verify_precedent_newplusplus_seed --expected-seed-version `"`$PRECEDENT_NEWPLUSPLUS_SEED_VERSION`" --format json",
