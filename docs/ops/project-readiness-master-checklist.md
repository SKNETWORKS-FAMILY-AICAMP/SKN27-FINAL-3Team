...
- [~] 법령 RAG의 PostgreSQL lexical ↔ pgvector 전환 기준, 임베딩·조문 chunk A/B, RAGAS 품질 평가 — #280, #282 (도구·공개 20개 평가셋·전환 gate·평가 전용 환경 preflight 완료, 실제 PostgreSQL A/B·RAGAS 결과 대기; 법령만, 판례·심의사례·과실기준 제외)
