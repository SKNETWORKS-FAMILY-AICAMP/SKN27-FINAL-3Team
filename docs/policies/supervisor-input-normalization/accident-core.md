...
| 상대차는 차선변경 | action | accident_fact.vehicle_actions.other | lane_change | 자동 | 주체가 상대 차량인지 불명확한 경우 | `accident.vehicle_actions.other.lane_change.exact_01` |
...
| 제차 앞범퍼와 상대차 옆문 충돌 | entity | accident_fact.collision_location | self_front_other_side | 자동 | 양 차량의 충돌 부위가 함께 확인되지 않는 경우 | `accident.collision_location.self_front_other_side.exact_01` |
