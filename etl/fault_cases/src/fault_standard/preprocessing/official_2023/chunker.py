            ...
            chunks.append(
                {
                    ...
                    "base_fault_type": base_fault.get("base_fault_type"),
                    "normalized_ratio": base_fault.get("normalized_ratio"),
                    "accident_group": accident_classification.get("accident_group"),
                    "accident_subgroup": accident_classification.get("accident_subgroup"),
                    "accident_tags": build_accident_tags(accident_classification),
...
def build_accident_tags(accident_classification: Dict[str, Any]) -> List[str]:
