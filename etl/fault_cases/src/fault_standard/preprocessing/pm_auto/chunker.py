            ...
            chunks.append(
                {
                    ...
                    "accident_subgroup": accident_classification.get("accident_subgroup"),
                    "pm_party_key": pm_context.get("pm_party_key"),
                    "pm_action": pm_context.get("pm_action"),
                    "accident_tags": build_accident_tags(accident_classification, pm_context),
...
def build_accident_tags(accident_classification: Dict[str, Any], pm_context: Dict[str, Any]) -> List[str]:
    ...
    values = [
        ...
        accident_classification.get("primary_violation"),
        pm_context.get("pm_road_position"),
    ]
