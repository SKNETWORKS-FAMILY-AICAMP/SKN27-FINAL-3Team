            ...
            chunks.append(
                {
                    ...
                    "round_no": section["round_no"],
                    "rule_title": section["rule_title"],
                    "major_group": accident_classification.get("accident_group"),
                    "red_ratio": base_fault.get("red_ratio"),
                    "blue_ratio": base_fault.get("blue_ratio"),
                    "red_path": lane_path_context.get("red_path"),
                    "blue_path": lane_path_context.get("blue_path"),
                    "collision_zone": accident_classification.get("collision_zone"),
                    "accident_tags": build_accident_tags(accident_classification, lane_path_context),
...
def build_accident_tags(accident_classification: Dict[str, Any], lane_path_context: Dict[str, Any]) -> List[str]:
    ...
    values = [
        ...
        accident_classification.get("collision_zone"),
        accident_classification.get("vehicle_relation"),
        lane_path_context.get("path_conflict_type"),
    ]
